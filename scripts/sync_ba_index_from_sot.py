...
GUARD_MESSAGE = (
    "REFUSING TO RUN: SOT index sync scripts are disabled by default. The Board "
    "Licensure Action Source Index in the HTML is maintained directly, and "
    "re-syncing from the xlsx can overwrite curated edits.\n\n"
